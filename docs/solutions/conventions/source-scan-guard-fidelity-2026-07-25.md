...
Five ways a source scan was green while the rule it names was violable — four from the launch-ordering work, one from the dictation-delivery work (whose case also widened item 2). Walk these whenever writing or reviewing a source scan:
